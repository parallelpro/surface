...
if __name__ == '__main__':
    ...
    print(ipart)
    suffix = 'spec_gaia_nu_sc_sep' # 'spec_gaia_nu_sc' #  #sys.argv[2]
    ...
    outdir = '/Users/yaguang/results_{:s}/'.format(suffix)
    ...
    lists = []
    tracks = ['/Users/yaguang/calibratedsep/'+f for f in os.listdir('/Users/yaguang/calibratedsep/') if (f.endswith('.npy') )]
    ...
    "estimators": ['index', 'star_age', 'star_mass', 'radius', 'density',\
                ...
                'profile_number', 'Dnu_freq_o', 'eps_o', 'surf_corr_at_numax'],
